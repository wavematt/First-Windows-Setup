Write-Host "Checking Adobe Reader DC Installation"
$directoryInfo = Get-ChildItem "C:\Program Files (x86)\Adobe\Acrobat Reader DC\" | Measure-Object
...
if ( $directoryInfo -ne 0 ) {
    ...
    #Installing Adobe Reader DC (yeah, I know...)
